...
coffeeA = Coffeeshop.create(email: "nicecafe@wagon.com", name: "taz Café", description: "some description", address: "Friedrichstraße 215, 10969 Berlin", website: "westberlin-bar-shop.de", password: '123456', password_confirmation: '123456')
coffeeB = Coffeeshop.create(email: "prettycafe@wagon.com", name: "Cafe Journale", description: "another description", address: "Lindenstraße 37 Berlin", website: "hashtagberlin.net", password: '123456', password_confirmation: '123456')
coffeeC = Coffeeshop.create(email: "justcafe@wagon.com", name: "Café Dix", description: "some more description", address: "Alte Jakobstraße 124-128 Berlin", website: "refinerycoffee.de", password: '123456', password_confirmation: '123456')
coffeeA = Coffeeshop.create(email: "coolcafe@wagon.com", name: "Hallesches Haus", description: "some description", address: "Tempelhofer Ufer 1 Berlin", website: "westberlin-bar-shop.de", password: '123456', password_confirmation: '123456')
coffeeB = Coffeeshop.create(email: "heycafe@wagon.com", name: "Café Anna Blume", description: "another description", address: "Kollwitzstraße 83 Berlin", website: "hashtagberlin.net", password: '123456', password_confirmation: '123456')
coffeeC = Coffeeshop.create(email: "yolocafe@wagon.com", name: "Café Hilde", description: "some more description", address: "Metzer Str. 22 Berlin", website: "refinerycoffee.de", password: '123456', password_confirmation: '123456')
coffeeA = Coffeeshop.create(email: "cacafe@wagon.com", name: "Chupenga Burritos & Salads", description: "some description", address: "Charlottenstraße 4 Berlin", website: "westberlin-bar-shop.de", password: '123456', password_confirmation: '123456')
coffeeB = Coffeeshop.create(email: "yescafe@wagon.com", name: "Unicorn.Berlin Mitte", description: "another description", address: "Brunnenstraße 173, 10115 Berlin", website: "hashtagberlin.net", password: '123456', password_confirmation: '123456')
coffeeC = Coffeeshop.create(email: "nocafe@wagon.com", name: "Café P1", description: "some more description", address: "Panoramastraße 1, 10178 Berlin", website: "refinerycoffee.de", password: '123456', password_confirmation: '123456')
coffeeA = Coffeeshop.create(email: "whycafe@wagon.com", name: "Cafe Lucre", description: "some description", address: "Voßstraße 35 Berlin", website: "westberlin-bar-shop.de", password: '123456', password_confirmation: '123456')
coffeeB = Coffeeshop.create(email: "pleasecafe@wagon.com", name: "Volcano's Lava Rock Cafe", description: "another description", address: "Volcano, HI, United States", website: "hashtagberlin.net", password: '123456', password_confirmation: '123456')
